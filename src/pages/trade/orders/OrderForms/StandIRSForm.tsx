...
interface StandIRSFormProps extends FormComponentProps {
}

class StandIRSForm extends React.Component<StandIRSFormProps, any> {
  componentDidMount() {
            ...
            <Form.Item label="合约品种:">
              {getFieldDecorator('合约品种', {
                ...
                <Select placeholder="请选择合约品种">
                  <Option value="SS3M_1912">SS3M_1912</Option>
                  <Option value="SS3M_2003">SS3M_2003</Option>
                  <Option value="SS3M_2006">SS3M_2006</Option>
                </Select>,
              )}
            </Form.Item>
...
export default Form.create<StandIRSFormProps>({
})(StandIRSForm);
